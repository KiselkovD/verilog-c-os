...
VL_ATTR_COLD void Vriscv_tcm_top_riscv_core__M0_MBffffffff___ctor_var_reset(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->u_lsu__DOT____Vcellout__u_lsu_request__data_out_o = VL_RAND_RESET_Q(36);
    ...
    vlSelf->u_mul__DOT____VdfgTmp_h5fcd7459__0 = 0;
