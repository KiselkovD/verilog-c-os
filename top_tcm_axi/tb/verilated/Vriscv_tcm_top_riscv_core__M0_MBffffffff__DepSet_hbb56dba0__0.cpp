...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_core__M0_MBffffffff___ico_sequent__TOP__v__u_core__0(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___ico_sequent__TOP__v__u_core__0\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_core__M0_MBffffffff___ico_sequent__TOP__v__u_core__1(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___ico_sequent__TOP__v__u_core__1\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_sequent__TOP__v__u_core__0(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_sequent__TOP__v__u_core__0\n"); );
    // Init
    ...
    CData/*0:0*/ __Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v0;
    __Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v0 = 0;
    CData/*0:0*/ __Vdlyvdim0__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2;
    __Vdlyvdim0__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2 = 0;
    QData/*35:0*/ __Vdlyvval__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2;
    __Vdlyvval__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2 = 0;
    CData/*0:0*/ __Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2;
    __Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2 = 0;
    ...
    // Body
    vlSelf->__Vdly__u_div__DOT__quotient_q = vlSelf->__PVT__u_div__DOT__quotient_q;
    __Vdly__u_div__DOT__divisor_q = vlSelf->__PVT__u_div__DOT__divisor_q;
    vlSelf->__Vdly__u_div__DOT__dividend_q = vlSelf->__PVT__u_div__DOT__dividend_q;
    __Vdly__u_div__DOT__q_mask_q = vlSelf->__PVT__u_div__DOT__q_mask_q;
    __Vdly__u_lsu__DOT__u_lsu_request__DOT__count_q 
        = vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__count_q;
    __Vdly__u_lsu__DOT__u_lsu_request__DOT__rd_ptr_q 
        = vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__rd_ptr_q;
    __Vdly__u_lsu__DOT__mem_unaligned_e1_q = vlSelf->__PVT__u_lsu__DOT__mem_unaligned_e1_q;
    __Vdly__u_lsu__DOT__mem_wr_q = vlSelf->__PVT__u_lsu__DOT__mem_wr_q;
    __Vdly__u_lsu__DOT__mem_rd_q = vlSelf->__PVT__u_lsu__DOT__mem_rd_q;
    __Vdly__u_lsu__DOT__u_lsu_request__DOT__wr_ptr_q 
        = vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__wr_ptr_q;
    __Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v0 = 0U;
    __Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2 = 0U;
    if (vlSymsp->TOP.__Vcellinp__v__rst_cpu_i) {
        vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__i = 2U;
        vlSelf->__Vdly__u_div__DOT__dividend_q = 0U;
        __Vdly__u_div__DOT__divisor_q = 0ULL;
        vlSelf->__Vdly__u_div__DOT__quotient_q = 0U;
        ...
        __Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v0 = 1U;
        vlSelf->__PVT__u_exec__DOT__branch_jmp_q = 0U;
        vlSelf->__PVT__u_exec__DOT__branch_ret_q = 0U;
        vlSelf->__PVT__u_exec__DOT__branch_call_q = 0U;
        vlSelf->__PVT__u_exec__DOT__branch_ntaken_q = 0U;
        vlSelf->__PVT__u_exec__DOT__branch_taken_q = 0U;
        vlSelf->__PVT__u_exec__DOT__pc_m_q = 0U;
        vlSelf->__PVT__u_exec__DOT__pc_x_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__icache_fetch_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__active_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__pending_lsu_e2_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__branch_d_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__pc_d_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__priv_f_q = 3U;
        vlSelf->__PVT__u_mul__DOT__operand_b_e1_q = 0ULL;
        vlSelf->__PVT__u_mul__DOT__operand_a_e1_q = 0ULL;
        vlSelf->__PVT__u_mul__DOT__result_e3_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[0U] = 0U;
        vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[1U] = 0U;
        vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[2U] = 0U;
        vlSelf->__PVT__u_div__DOT__div_busy_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_addr_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_data_wr_q = 0U;
        __Vdly__u_lsu__DOT__mem_rd_q = 0U;
        __Vdly__u_lsu__DOT__mem_wr_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_cacheable_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_writeback_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_flush_q = 0U;
        __Vdly__u_lsu__DOT__mem_unaligned_e1_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_load_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_xb_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_xh_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_ls_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__pc_f_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__branch_priv_q = 3U;
        vlSelf->__PVT__u_fetch__DOT__branch_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__branch_pc_q = 0U;
    } else {
        if (vlSelf->__PVT__u_div__DOT__div_start_w) {
            vlSelf->__Vdly__u_div__DOT__dividend_q 
                = (((IData)(vlSelf->__PVT__u_div__DOT__signed_operation_w) 
                    & (vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_ra_value_r 
                       >> 0x1fU)) ? (- vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_ra_value_r)
                    : vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_ra_value_r);
            __Vdly__u_div__DOT__divisor_q = (((IData)(vlSelf->__PVT__u_div__DOT__signed_operation_w) 
                                              & (vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_rb_value_r 
                                                 >> 0x1fU))
                                              ? ((QData)((IData)(
                                                                 (- vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_rb_value_r))) 
            ...
            vlSelf->__PVT__u_div__DOT__div_busy_q = 1U;
        } else {
            if ((1U & (~ (IData)(vlSelf->__PVT__u_div__DOT__div_complete_w)))) {
                if (vlSelf->__PVT__u_div__DOT__div_busy_q) {
                    if ((vlSelf->__PVT__u_div__DOT__divisor_q 
                         <= (QData)((IData)(vlSelf->__PVT__u_div__DOT__dividend_q)))) {
                        vlSelf->__Vdly__u_div__DOT__dividend_q 
                            = (vlSelf->__PVT__u_div__DOT__dividend_q 
                               - (IData)(vlSelf->__PVT__u_div__DOT__divisor_q));
                        vlSelf->__Vdly__u_div__DOT__quotient_q 
                            = (vlSelf->__PVT__u_div__DOT__quotient_q 
                               | vlSelf->__PVT__u_div__DOT__q_mask_q);
                    }
                    __Vdly__u_div__DOT__divisor_q = 
                        (0x3fffffffffffffffULL & (vlSelf->__PVT__u_div__DOT__divisor_q 
                                                  >> 1U));
            ...
            if (vlSelf->__PVT__u_div__DOT__div_complete_w) {
                vlSelf->__PVT__u_div__DOT__div_busy_q = 0U;
            }
        }
        if ((((IData)(vlSelf->u_lsu__DOT____Vcellinp__u_lsu_request__push_i) 
              & (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__accept_o)) 
             & (~ ((IData)(vlSelf->__PVT__writeback_mem_valid_w) 
                   & (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__valid_o))))) {
            __Vdly__u_lsu__DOT__u_lsu_request__DOT__count_q 
                = (3U & ((IData)(1U) + (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__count_q)));
        } else if (((~ ((IData)(vlSelf->u_lsu__DOT____Vcellinp__u_lsu_request__push_i) 
                        & (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__accept_o))) 
                    & ((IData)(vlSelf->__PVT__writeback_mem_valid_w) 
                       & (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__valid_o)))) {
            __Vdly__u_lsu__DOT__u_lsu_request__DOT__count_q 
                = (3U & ((IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__count_q) 
                         - (IData)(1U)));
        }
        if (((IData)(vlSelf->__PVT__writeback_mem_valid_w) 
             & (0U != (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__count_q)))) {
            __Vdly__u_lsu__DOT__u_lsu_request__DOT__rd_ptr_q 
                = (1U & ((IData)(1U) + (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__rd_ptr_q)));
        }
        if (((IData)(vlSelf->u_lsu__DOT____Vcellinp__u_lsu_request__push_i) 
             & (2U != (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__count_q)))) {
            __Vdlyvval__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2 
                = (((QData)((IData)(vlSelf->__PVT__u_lsu__DOT__mem_addr_q)) 
                    << 4U) | (QData)((IData)((((IData)(vlSelf->__PVT__u_lsu__DOT__mem_ls_q) 
                                               << 3U) 
                                              | (((IData)(vlSelf->__PVT__u_lsu__DOT__mem_xh_q) 
                                                  << 2U) 
                                                 | (((IData)(vlSelf->__PVT__u_lsu__DOT__mem_xb_q) 
                                                     << 1U) 
                                                    | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_load_q)))))));
            __Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2 = 1U;
            __Vdlyvdim0__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2 
                = vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__wr_ptr_q;
            __Vdly__u_lsu__DOT__u_lsu_request__DOT__wr_ptr_q 
                = (1U & ((IData)(1U) + (IData)(vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__wr_ptr_q)));
        }
        if (vlSymsp->TOP__v__u_core__u_issue.__PVT__opcode_issue_r) {
            vlSelf->__PVT__u_exec__DOT__branch_jmp_q 
                = (((IData)(vlSelf->__PVT__u_exec__DOT__branch_r) 
                    & (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__opcode_issue_r)) 
                   & (IData)(vlSelf->__PVT__u_exec__DOT__branch_jmp_r));
            vlSelf->__PVT__u_exec__DOT__branch_ret_q 
                = (((IData)(vlSelf->__PVT__u_exec__DOT__branch_r) 
                    & (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__opcode_issue_r)) 
                   & (IData)(vlSelf->__PVT__u_exec__DOT__branch_ret_r));
            vlSelf->__PVT__u_exec__DOT__branch_call_q 
                = (((IData)(vlSelf->__PVT__u_exec__DOT__branch_r) 
                    & (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__opcode_issue_r)) 
                   & (IData)(vlSelf->__PVT__u_exec__DOT__branch_call_r));
            vlSelf->__PVT__u_exec__DOT__branch_ntaken_q 
                = ((IData)(vlSelf->__PVT__u_exec__DOT__branch_r) 
                   & ((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__opcode_issue_r) 
                      & (~ (IData)(vlSelf->__PVT__u_exec__DOT__branch_taken_r))));
            vlSelf->__PVT__u_exec__DOT__branch_taken_q 
                = ((IData)(vlSelf->__PVT__u_exec__DOT__branch_r) 
                   & ((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__opcode_issue_r) 
                      & (IData)(vlSelf->__PVT__u_exec__DOT__branch_taken_r)));
            vlSelf->__PVT__u_exec__DOT__pc_m_q = vlSelf->__PVT__fetch_pc_w;
            vlSelf->__PVT__u_exec__DOT__pc_x_q = ((IData)(vlSelf->__PVT__u_exec__DOT__branch_taken_r)
                                                   ? vlSelf->__PVT__u_exec__DOT__branch_target_r
                                                   : 
                                                  ((IData)(4U) 
                                                   + vlSelf->__PVT__fetch_pc_w));
        }
        if (vlSelf->__PVT__mem_i_rd_o) {
            vlSelf->__PVT__u_fetch__DOT__icache_fetch_q = 1U;
            vlSelf->__PVT__u_fetch__DOT__pc_d_q = vlSelf->__PVT__u_fetch__DOT__pc_f_q;
        } else if (vlSymsp->TOP__v__u_tcm.__PVT__mem_i_valid_q) {
            vlSelf->__PVT__u_fetch__DOT__icache_fetch_q = 0U;
        }
        if (((IData)(vlSelf->__PVT__u_fetch__DOT__branch_q) 
             & (~ (IData)(vlSelf->__PVT__u_fetch__DOT__stall_w)))) {
            vlSelf->__PVT__u_fetch__DOT__active_q = 1U;
            vlSelf->__PVT__u_fetch__DOT__branch_d_q = 1U;
            vlSelf->__PVT__u_fetch__DOT__priv_f_q = vlSelf->__PVT__u_fetch__DOT__branch_priv_q;
            vlSelf->__PVT__u_fetch__DOT__pc_f_q = vlSelf->__PVT__u_fetch__DOT__branch_pc_q;
        } else if ((1U & (~ (IData)(vlSelf->__PVT__u_fetch__DOT__stall_w)))) {
            vlSelf->__PVT__u_fetch__DOT__branch_d_q = 0U;
            vlSelf->__PVT__u_fetch__DOT__pc_f_q = ((IData)(4U) 
                                                   + 
                                                   (0xfffffffcU 
                                                    & vlSelf->__PVT__u_fetch__DOT__icache_pc_w));
        }
        if (vlSelf->__PVT__u_lsu__DOT__issue_lsu_e1_w) {
            vlSelf->__PVT__u_lsu__DOT__pending_lsu_e2_q = 1U;
        } else if (((IData)(vlSelf->__PVT__u_lsu__DOT__complete_ok_e2_w) 
                    | (IData)(vlSelf->__PVT__u_lsu__DOT__complete_err_e2_w))) {
            vlSelf->__PVT__u_lsu__DOT__pending_lsu_e2_q = 0U;
        }
        if ((1U & (~ (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__exec_hold_o)))) {
            if (((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__opcode_issue_r) 
                 & (IData)(vlSelf->__PVT__u_mul__DOT__mult_inst_w))) {
                if ((0x2002033U == (0xfe00707fU & vlSelf->__PVT__fetch_instr_w))) {
                    vlSelf->__PVT__u_mul__DOT__operand_b_e1_q 
                        = (QData)((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_rb_value_r));
                    vlSelf->__PVT__u_mul__DOT__operand_a_e1_q 
                        = vlSelf->u_mul__DOT____VdfgTmp_h5fcd7459__0;
            ...
            vlSelf->__PVT__u_mul__DOT__result_e3_q 
                = vlSelf->__PVT__u_mul__DOT__result_e2_q;
        }
        if (((IData)(vlSelf->__PVT__fetch_dec_valid_w) 
             & (~ (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__fetch_accept_o)))) {
            vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[0U] 
                = (IData)((((QData)((IData)(vlSelf->__PVT__fetch_pc_w)) 
                            << 0x20U) | (QData)((IData)(vlSelf->__PVT__fetch_dec_instr_w))));
            vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[1U] 
                = (IData)(((((QData)((IData)(vlSelf->__PVT__fetch_pc_w)) 
                             << 0x20U) | (QData)((IData)(vlSelf->__PVT__fetch_dec_instr_w))) 
                           >> 0x20U));
            vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[2U] 
                = (((IData)(vlSelf->__PVT__fetch_fault_page_w) 
                    << 1U) | (IData)(vlSelf->__PVT__fetch_dec_fault_fetch_w));
        } else {
            vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[0U] = 0U;
            vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[1U] = 0U;
            vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[2U] = 0U;
        }
        if (((IData)(vlSelf->__PVT__u_lsu__DOT__complete_err_e2_w) 
             | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_e2_q))) {
            vlSelf->__PVT__u_lsu__DOT__mem_addr_q = 0U;
            vlSelf->__PVT__u_lsu__DOT__mem_data_wr_q = 0U;
            __Vdly__u_lsu__DOT__mem_rd_q = 0U;
            ...
            vlSelf->__PVT__u_lsu__DOT__mem_xh_q = 0U;
            vlSelf->__PVT__u_lsu__DOT__mem_ls_q = 0U;
        } else if ((1U & (~ ((((IData)(vlSelf->__PVT__u_lsu__DOT__mem_rd_q) 
                               | (0U != (IData)(vlSelf->__PVT__u_lsu__DOT__mem_wr_q))) 
                              | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_e1_q)) 
                             & (IData)(vlSelf->__PVT__u_lsu__DOT__delay_lsu_e2_w))))) {
            if ((1U & (~ ((((((IData)(vlSelf->__PVT__mem_d_writeback_o) 
                              | (IData)(vlSelf->__PVT__mem_d_invalidate_o)) 
                             | (IData)(vlSelf->__PVT__mem_d_flush_o)) 
                            | (IData)(vlSelf->__PVT__mem_d_rd_o)) 
                           | (0U != (IData)(vlSelf->__PVT__mem_d_wr_o))) 
                          & (~ (IData)(vlSymsp->TOP__v.__PVT__dport_accept_w)))))) {
                vlSelf->__PVT__u_lsu__DOT__mem_addr_q = 0U;
                vlSelf->__PVT__u_lsu__DOT__mem_data_wr_q 
                    = vlSelf->__PVT__u_lsu__DOT__mem_data_r;
                __Vdly__u_lsu__DOT__mem_rd_q = vlSelf->__PVT__u_lsu__DOT__mem_rd_r;
                __Vdly__u_lsu__DOT__mem_wr_q = vlSelf->__PVT__u_lsu__DOT__mem_wr_r;
                vlSelf->__PVT__u_lsu__DOT__mem_cacheable_q = 0U;
                vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q = 0U;
                vlSelf->__PVT__u_lsu__DOT__mem_writeback_q = 0U;
                vlSelf->__PVT__u_lsu__DOT__mem_flush_q = 0U;
                __Vdly__u_lsu__DOT__mem_unaligned_e1_q 
                    = vlSelf->__PVT__u_lsu__DOT__mem_unaligned_r;
                vlSelf->__PVT__u_lsu__DOT__mem_load_q 
                    = ((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__lsu_opcode_valid_o) 
                       & (IData)(vlSelf->__PVT__u_lsu__DOT__load_inst_w));
                vlSelf->__PVT__u_lsu__DOT__mem_xb_q 
                    = (((3U == (0x707fU & vlSelf->__PVT__fetch_instr_w)) 
                        | (0x4003U == (0x707fU & vlSelf->__PVT__fetch_instr_w))) 
                       | (0x23U == (0x707fU & vlSelf->__PVT__fetch_instr_w)));
                vlSelf->__PVT__u_lsu__DOT__mem_xh_q 
                    = ((IData)(vlSelf->__PVT__u_lsu__DOT__req_lh_w) 
                       | (0x1023U == (0x707fU & vlSelf->__PVT__fetch_instr_w)));
                vlSelf->__PVT__u_lsu__DOT__mem_ls_q 
                    = vlSelf->__PVT__u_lsu__DOT__load_signed_inst_w;
                vlSelf->__PVT__u_lsu__DOT__mem_cacheable_q = 1U;
                vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q 
                    = ((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__lsu_opcode_valid_o) 
                       & (IData)((0x3a201073U == (0xfff0707fU 
                                                  & vlSelf->__PVT__fetch_instr_w))));
                vlSelf->__PVT__u_lsu__DOT__mem_writeback_q 
                    = ((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__lsu_opcode_valid_o) 
                       & (IData)((0x3a101073U == (0xfff0707fU 
                                                  & vlSelf->__PVT__fetch_instr_w))));
                vlSelf->__PVT__u_lsu__DOT__mem_flush_q 
                    = ((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__lsu_opcode_valid_o) 
                       & (IData)((0x3a001073U == (0xfff0707fU 
                                                  & vlSelf->__PVT__fetch_instr_w))));
                vlSelf->__PVT__u_lsu__DOT__mem_addr_q 
                    = vlSelf->__PVT__u_lsu__DOT__mem_addr_r;
            }
        }
        if (vlSymsp->TOP__v__u_core__u_issue.__PVT__branch_request_o) {
            if (vlSymsp->TOP__v__u_core__u_csr.__PVT__branch_q) {
                vlSelf->__PVT__u_fetch__DOT__branch_priv_q 
                    = vlSymsp->TOP__v__u_core__u_csr.__PVT__branch_csr_priv_o;
                vlSelf->__PVT__u_fetch__DOT__branch_pc_q 
                    = vlSymsp->TOP__v__u_core__u_csr.__PVT__branch_target_q;
            } else {
                vlSelf->__PVT__u_fetch__DOT__branch_priv_q 
                    = vlSymsp->TOP__v__u_core__u_issue.__PVT__priv_x_q;
                vlSelf->__PVT__u_fetch__DOT__branch_pc_q 
                    = vlSelf->__PVT__u_exec__DOT__branch_target_r;
            }
            vlSelf->__PVT__u_fetch__DOT__branch_q = 1U;
        } else if (vlSelf->__PVT__mem_i_rd_o) {
            vlSelf->__PVT__u_fetch__DOT__branch_q = 0U;
            vlSelf->__PVT__u_fetch__DOT__branch_pc_q = 0U;
        }
    }
    vlSelf->__PVT__u_fetch__DOT__icache_invalidate_q = 0U;
    vlSelf->__PVT__u_fetch__DOT__stall_q = ((~ (IData)(vlSymsp->TOP.__Vcellinp__v__rst_cpu_i)) 
                                            & (IData)(vlSelf->__PVT__u_fetch__DOT__stall_w));
    vlSelf->__PVT__u_fetch__DOT__skid_valid_q = ((1U 
                                                  & (~ (IData)(vlSymsp->TOP.__Vcellinp__v__rst_cpu_i))) 
                                                 && ((IData)(vlSelf->__PVT__fetch_dec_valid_w) 
                                                     & (~ (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__fetch_accept_o))));
    vlSelf->__PVT__u_div__DOT__divisor_q = __Vdly__u_div__DOT__divisor_q;
    vlSelf->__PVT__u_div__DOT__q_mask_q = __Vdly__u_div__DOT__q_mask_q;
    vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__rd_ptr_q 
        = __Vdly__u_lsu__DOT__u_lsu_request__DOT__rd_ptr_q;
    vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__wr_ptr_q 
        = __Vdly__u_lsu__DOT__u_lsu_request__DOT__wr_ptr_q;
    vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__count_q 
        = __Vdly__u_lsu__DOT__u_lsu_request__DOT__count_q;
    if (__Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v0) {
        vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__ram_q[0U] = 0ULL;
        vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__ram_q[1U] = 0ULL;
    }
    if (__Vdlyvset__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2) {
        vlSelf->__PVT__u_lsu__DOT__u_lsu_request__DOT__ram_q[__Vdlyvdim0__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2] 
            = __Vdlyvval__u_lsu__DOT__u_lsu_request__DOT__ram_q__v2;
    }
    ...
    vlSelf->__PVT__fetch_dec_fault_fetch_w = ((IData)(vlSelf->__PVT__u_fetch__DOT__skid_valid_q) 
                                              && (1U 
                                                  & vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[2U]));
    vlSelf->__PVT__u_lsu__DOT__mem_rd_q = __Vdly__u_lsu__DOT__mem_rd_q;
    vlSelf->__PVT__u_lsu__DOT__mem_wr_q = __Vdly__u_lsu__DOT__mem_wr_q;
    ...
    vlSelf->__PVT__u_lsu__DOT__mem_unaligned_e2_q = 
        ((~ (IData)(vlSymsp->TOP.__Vcellinp__v__rst_cpu_i)) 
         & ((IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_e1_q) 
            & (~ (IData)(vlSelf->__PVT__u_lsu__DOT__delay_lsu_e2_w))));
    vlSelf->__PVT__u_fetch__DOT__icache_pc_w = vlSelf->__PVT__u_fetch__DOT__pc_f_q;
    vlSelf->__PVT__u_lsu__DOT__mem_unaligned_e1_q = __Vdly__u_lsu__DOT__mem_unaligned_e1_q;
}

VL_INLINE_OPT void Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_sequent__TOP__v__u_core__1(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_sequent__TOP__v__u_core__1\n"); );
    // Init
    ...
    vlSelf->__PVT__fetch_pc_w = ((IData)(vlSelf->__PVT__u_fetch__DOT__skid_valid_q)
                                  ? vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[1U]
                                  : (0xfffffffcU & vlSelf->__PVT__u_fetch__DOT__pc_d_q));
    vlSelf->__PVT__u_div__DOT__valid_q = ((~ (IData)(vlSymsp->TOP.__Vcellinp__v__rst_cpu_i)) 
                                          & (IData)(vlSelf->__PVT__u_div__DOT__div_complete_w));
    if (vlSymsp->TOP.__Vcellinp__v__rst_cpu_i) {
        vlSelf->__PVT__u_mul__DOT__result_e2_q = 0U;
        vlSelf->__PVT__u_exec__DOT__result_q = 0U;
        vlSelf->__PVT__u_div__DOT__wb_result_q = 0U;
        vlSelf->__PVT__u_mul__DOT__mulhi_sel_e1_q = 0U;
        vlSelf->__PVT__u_div__DOT__div_inst_q = 0U;
        vlSelf->__PVT__u_div__DOT__invert_res_q = 0U;
    } else {
        if ((1U & (~ (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__exec_hold_o)))) {
            vlSelf->__PVT__u_mul__DOT__result_e2_q 
                = ((IData)(vlSelf->__PVT__u_mul__DOT__mulhi_sel_e1_q)
                    ? vlSelf->__PVT__u_mul__DOT__mult_result_w[1U]
                    : vlSelf->__PVT__u_mul__DOT__mult_result_w[0U]);
            vlSelf->__PVT__u_exec__DOT__result_q = vlSelf->__PVT__u_exec__DOT__u_alu__DOT__result_r;
            vlSelf->__PVT__u_mul__DOT__mulhi_sel_e1_q 
                = (((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__opcode_issue_r) 
                    & (IData)(vlSelf->__PVT__u_mul__DOT__mult_inst_w)) 
                   && (0x2000033U != (0xfe00707fU & vlSelf->__PVT__fetch_instr_w)));
        }
        if (vlSelf->__PVT__u_div__DOT__div_complete_w) {
            vlSelf->__PVT__u_div__DOT__wb_result_q 
                = ((IData)(vlSelf->__PVT__u_div__DOT__div_inst_q)
                    ? ((IData)(vlSelf->__PVT__u_div__DOT__invert_res_q)
                        ? (- vlSelf->__PVT__u_div__DOT__quotient_q)
                        : vlSelf->__PVT__u_div__DOT__quotient_q)
                    : ((IData)(vlSelf->__PVT__u_div__DOT__invert_res_q)
                        ? (- vlSelf->__PVT__u_div__DOT__dividend_q)
        ...
        if (vlSelf->__PVT__u_div__DOT__div_start_w) {
            vlSelf->__PVT__u_div__DOT__div_inst_q = vlSelf->__PVT__u_div__DOT__div_operation_w;
            vlSelf->__PVT__u_div__DOT__invert_res_q 
                = ((((0x2004033U == (0xfe00707fU & vlSelf->__PVT__fetch_instr_w)) 
                     & ((vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_ra_value_r 
                         >> 0x1fU) != (vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_rb_value_r 
                                       >> 0x1fU))) 
                    & (0U != vlSymsp->TOP__v__u_core__u_issue.__PVT__issue_rb_value_r)) 
    ...
    vlSelf->__PVT__u_mul__DOT__mult_result_w[2U] = 
        (1U & __Vtemp_4[2U]);
    vlSelf->__PVT__u_div__DOT__quotient_q = vlSelf->__Vdly__u_div__DOT__quotient_q;
    vlSelf->__PVT__u_div__DOT__dividend_q = vlSelf->__Vdly__u_div__DOT__dividend_q;
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_sequent__TOP__v__u_core__2(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_sequent__TOP__v__u_core__2\n"); );
    // Body
    vlSelf->__PVT__u_lsu__DOT__complete_err_e2_w = 
        ((IData)(vlSymsp->TOP__v.__PVT__dport_ack_w) 
         & (IData)(vlSymsp->TOP__v.__PVT__dport_error_w));
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_comb__TOP__v__u_core__0(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_comb__TOP__v__u_core__0\n"); );
    // Body
    vlSelf->__PVT__fetch_dec_instr_w = ((IData)(vlSelf->__PVT__u_fetch__DOT__skid_valid_q)
                                         ? vlSelf->__PVT__u_fetch__DOT__skid_buffer_q[0U]
                                         : vlSymsp->TOP__v__u_tcm__u_ram.__PVT__ram_read0_q);
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_comb__TOP__v__u_core__1(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_comb__TOP__v__u_core__1\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_comb__TOP__v__u_core__2(Vriscv_tcm_top_riscv_core__M0_MBffffffff* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_tcm_top_riscv_core__M0_MBffffffff___nba_comb__TOP__v__u_core__2\n"); );
    // Body
    vlSelf->__PVT__u_lsu__DOT__wb_result_r = 0U;
    vlSelf->__PVT__u_lsu__DOT__addr_lsb_r = (3U & (IData)(
                                                          (vlSelf->u_lsu__DOT____Vcellout__u_lsu_request__data_out_o 
