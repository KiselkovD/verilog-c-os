...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_csr_regfile___ico_sequent__TOP__v__u_core__u_csr__u_csrfile__0(Vriscv_tcm_top_riscv_csr_regfile* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_tcm_top_riscv_csr_regfile___ico_sequent__TOP__v__u_core__u_csr__u_csrfile__0\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__0(Vriscv_tcm_top_riscv_csr_regfile* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_tcm_top_riscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__0\n"); );
    // Body
    ...
    if (vlSymsp->TOP.__Vcellinp__v__rst_cpu_i) {
        vlSelf->__PVT__irq_priv_q = 3U;
    } else if ((0U != vlSelf->__PVT__irq_masked_r)) {
        vlSelf->__PVT__irq_priv_q = 3U;
    }
}

VL_INLINE_OPT void Vriscv_tcm_top_riscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__1(Vriscv_tcm_top_riscv_csr_regfile* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_tcm_top_riscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__1\n"); );
    // Body
    if (vlSymsp->TOP.__Vcellinp__v__rst_cpu_i) {
        vlSelf->__PVT__csr_mepc_q = 0U;
        vlSelf->__PVT__csr_sr_q = 0U;
        vlSelf->__PVT__csr_mcause_q = 0U;
        vlSelf->__PVT__csr_mtval_q = 0U;
        vlSelf->__PVT__csr_mtvec_q = 0U;
        vlSelf->__PVT__csr_mip_q = 0U;
        vlSelf->__PVT__csr_mie_q = 0U;
        vlSelf->__PVT__csr_mpriv_q = 3U;
        vlSelf->__Vdly__csr_mcycle_q = 0U;
        vlSelf->__Vdly__csr_mcycle_h_q = 0U;
        vlSelf->__PVT__csr_mscratch_q = 0U;
        vlSelf->__PVT__csr_mtimecmp_q = 0U;
        vlSelf->__PVT__csr_mtime_ie_q = 0U;
        vlSelf->__PVT__csr_medeleg_q = 0U;
        vlSelf->__PVT__csr_mideleg_q = 0U;
        vlSelf->__PVT__csr_sepc_q = 0U;
        vlSelf->__PVT__csr_stvec_q = 0U;
        vlSelf->__PVT__csr_scause_q = 0U;
        vlSelf->__PVT__csr_stval_q = 0U;
        vlSelf->__PVT__csr_satp_q = 0U;
        vlSelf->__PVT__csr_sscratch_q = 0U;
        vlSelf->__PVT__csr_mip_next_q = 0U;
    } else {
        if ((0xffffffffU == vlSelf->__PVT__csr_mcycle_q)) {
            vlSelf->__Vdly__csr_mcycle_h_q = ((IData)(1U) 
                                              + vlSelf->__PVT__csr_mcycle_h_q);
        }
        if ((((0x7b2U == (IData)(vlSymsp->TOP__v__u_core__u_csr.__Vcellinp__u_csrfile__csr_waddr_i)) 
              | (0x8b2U == (IData)(vlSymsp->TOP__v__u_core__u_csr.__Vcellinp__u_csrfile__csr_waddr_i))) 
             & (~ (IData)((0U != (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__u_pipe_ctrl__DOT__exception_wb_q)))))) {
            if (VL_UNLIKELY((0U == (0xff000000U & vlSymsp->TOP__v__u_core__u_issue.__PVT__u_pipe_ctrl__DOT__csr_wdata_wb_q)))) {
                ...
                VL_FINISH_MT("../../core/riscv/riscv_csr_regfile.v", 568, "");
                                                   ...
                                                   & vlSymsp->TOP__v__u_core__u_issue.__PVT__u_pipe_ctrl__DOT__csr_wdata_wb_q)))) {
                VL_WRITEF("%c",8,(0xffU & vlSymsp->TOP__v__u_core__u_issue.__PVT__u_pipe_ctrl__DOT__csr_wdata_wb_q));
            }
        }
        vlSelf->__PVT__csr_mepc_q = vlSelf->__PVT__csr_mepc_r;
        vlSelf->__PVT__csr_sr_q = vlSelf->__PVT__csr_sr_r;
        vlSelf->__PVT__csr_mcause_q = vlSelf->__PVT__csr_mcause_r;
        vlSelf->__PVT__csr_mtval_q = vlSelf->__PVT__csr_mtval_r;
        vlSelf->__PVT__csr_mtvec_q = vlSelf->__PVT__csr_mtvec_r;
        vlSelf->__PVT__csr_mip_q = vlSelf->__PVT__csr_mip_r;
        vlSelf->__PVT__csr_mie_q = vlSelf->__PVT__csr_mie_r;
        vlSelf->__PVT__csr_mpriv_q = 3U;
        vlSelf->__PVT__csr_mscratch_q = vlSelf->__PVT__csr_mscratch_r;
        vlSelf->__PVT__csr_mtimecmp_q = vlSelf->__PVT__csr_mtimecmp_r;
        vlSelf->__PVT__csr_mtime_ie_q = vlSelf->__PVT__csr_mtime_ie_r;
        vlSelf->__PVT__csr_medeleg_q = 0U;
        vlSelf->__PVT__csr_mideleg_q = 0U;
        vlSelf->__PVT__csr_sepc_q = 0U;
        vlSelf->__PVT__csr_stvec_q = 0U;
        ...
        vlSelf->__PVT__csr_satp_q = 0U;
        vlSelf->__PVT__csr_sscratch_q = 0U;
        vlSelf->__PVT__csr_mip_next_q = ((((IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__lsu_opcode_valid_o) 
                                           & ((0x344U 
    ...
    if (vlSymsp->TOP.__Vcellinp__v__rst_cpu_i) {
        vlSelf->__PVT__csr_mip_upd_q = 0U;
                ...
                & ((0x344U == (vlSymsp->TOP__v__u_core.__PVT__fetch_instr_w 
                               >> 0x14U)) | (0x144U 
                                             == (vlSymsp->TOP__v__u_core.__PVT__fetch_instr_w 
                                                 >> 0x14U))))) {
        vlSelf->__PVT__csr_mip_upd_q = 1U;
    } else if ((((0x344U == (IData)(vlSymsp->TOP__v__u_core__u_csr.__Vcellinp__u_csrfile__csr_waddr_i)) 
                 | (0x144U == (IData)(vlSymsp->TOP__v__u_core__u_csr.__Vcellinp__u_csrfile__csr_waddr_i))) 
                | (0U != (IData)(vlSymsp->TOP__v__u_core__u_issue.__PVT__u_pipe_ctrl__DOT__exception_wb_q)))) {
        vlSelf->__PVT__csr_mip_upd_q = 0U;
    }
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__2(Vriscv_tcm_top_riscv_csr_regfile* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_tcm_top_riscv_csr_regfile___nba_sequent__TOP__v__u_core__u_csr__u_csrfile__2\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_tcm_top_riscv_csr_regfile___nba_comb__TOP__v__u_core__u_csr__u_csrfile__0(Vriscv_tcm_top_riscv_csr_regfile* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_tcm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_tcm_top_riscv_csr_regfile___nba_comb__TOP__v__u_core__u_csr__u_csrfile__0\n"); );
    // Body
